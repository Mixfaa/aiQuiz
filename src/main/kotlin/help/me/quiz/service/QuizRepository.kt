...
interface QuizRepository : ReactiveMongoRepository<QuizEntity, ObjectId> {
    @Query("{ \$text :  {\$search: \"?1\"}}")
    ...
    fun findByIdAndCreator(id: ObjectId, creator: Account): Mono<QuizEntity>
    fun deleteByIdAndCreator(id: ObjectId, creator: Account): Mono<Boolean>
